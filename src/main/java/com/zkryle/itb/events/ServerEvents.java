    ...
    public static void levelTick(TickEvent.LevelTickEvent event){
        ...
        level.blockEntityTickers.forEach((blockEntityTicker -> {
            ...
            if(blockEntity instanceof AbstractFurnaceBlockEntity){
                ...
                ITBPacketHandler.CHANNEL.send(PacketDistributor.TRACKING_CHUNK.with(() -> level.getChunkAt(blockEntityTicker.getPos())), new FurnaceItemSlotsUploadPacket(size, itemsTag, blockEntity.getBlockPos().asLong()));
            }
